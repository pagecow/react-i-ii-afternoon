...
class Info extends Component {
    ...
    jobTitleChangeHandler(value){
        this.setState({
            jobTitle: value
        })
    }

    employerChangeHandler(value){
        this.setState({
            employer: value
        })
    }

    favoriteMoviesChangeHandler(value){
        this.setState({
    ...
    render(){
        return(
            <div>
                <h1 className='person-number'>{this.state.id}</h1>
                
                <h1 className='person-name'>{this.state.name}</h1>

                <br></br>
                <h3>FROM: {this.state.from}</h3>
                <h3>JOB TITLE: {this.state.jobTitle}</h3>
